<template>
 ...
 <!--    <div class="head-box">
    ...
    <el-table :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%" :row-class-name="tableRowClassName" :height="height" tooltip-effect="dark">
      <el-table-column width="200px" align="center" label="所评企业" prop="enterpriseName"></el-table-column>
      <el-table-column width="250px" align="center" label="描述" prop="writing" show-overflow-tooltip></el-table-column>
      <el-table-column width="250px" align="center" label="评价分数" prop="grade"></el-table-column>
      <el-table-column width="200px" align="center" label="提交时间" prop="createTime"></el-table-column>
      <!-- <el-table-column width="200px" align="center" label="提交平台" prop="submitPlatform" :formatter="submitPlatformFormatter"></el-table-column> -->
        ...
        <el-tabs v-model="viewTabPanl">
          <el-tab-pane label="基本信息">
            <el-form :model="form" :rules="rules" ref="form" label-width="100px">
              <el-form-item v-if="isView" label="企业" prop="enterpriseName">
                <el-input v-model="form.enterpriseName" disabled></el-input>
              </el-form-item>
              <el-form-item v-if="!isView" label="评价企业" prop="enterprisId">
              ...
              <el-form-item label="评分" prop="gradeStar">
                <el-rate v-model="gradeStar" allow-half show-score text-color="#ff9900" :disabled="isView" :score-template="gradeShow" @change="handleGradeChange" style="padding-top: 10px;">
                </el-rate>
              </el-form-item>
              <el-form-item label="评价描述" prop="writing">
                <el-input type="textarea" :rows="2" v-model="form.writing" :disabled="isView"></el-input>
              </el-form-item>
              <el-form-item label="评价晒图" prop="imgFile" ref="imgFile">
