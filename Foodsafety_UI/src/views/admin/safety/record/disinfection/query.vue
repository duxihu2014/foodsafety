...
export default {
  ...
  methods: {
    ...
    resetQuery() {
      ...
      this.listQuery = {page: page, limit: limit, disinfectionTime: [], enterpriseId: undefined, areaId: undefined, gridId: undefined };
    },
