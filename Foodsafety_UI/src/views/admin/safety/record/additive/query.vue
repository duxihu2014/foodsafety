<template>
  <div class="app-container calendar-list-container">
    <fieldset class="fieldset">
      ...
      <div class="field-box">
        <el-form :inline="true" :model="listQuery">
          ...
          <el-form-item label="使用日期" prop="userStatus" class="filter-item">
    ...
    <el-table :key='tableKey' :data="tableList" v-loading.body="listLoading" border highlight-current-row style="width: 100%" @selection-change="getSelection" :row-class-name="tableRowClassName" :height="height" tooltip-effect="dark">
      ...
      <el-table-column width="250px" align="center" label="企业名称" prop="enterpriseName" show-overflow-tooltip :formatter="function(row,column,cellValue){return enterpriseformatter(row.enterpriseId)}"></el-table-column>
    ...
    intiParam() {
      ...
      getAllEnterpriseMap()
        .then(function(response) {
          ...
          // console.log(JSON.stringify(_this.allEnterpriseOptions))
        })
        .catch(() => {
          this.$message({
            type: "error",
