...
export default {
  ...
  methods: {
    ...
    getCateringStaffMap() {
      this.staffQuery.enterpriseId = this.user.enterpriseId;
      getCateringStaffMap(this.staffQuery).then(response => {
    ...
    resetQuery() {
      this.listQuery = { checkTime: [], enterpriseId: undefined };
    },
