<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table   :data="list" v-loading.body="listLoading" border  highlight-current-row style="width: 100%" @selection-change="getSelection"  :row-class-name="tableRowClassName" :height="height"	>
      ...
      <el-table-column align="center" label="规格" width="150" prop="specification" ></el-table-column>
      <el-table-column align="center" label="单位" width="150" prop="unit" ></el-table-column>
      <el-table-column align="center" label="保质期（天）" width="150" prop="shelfLife" ></el-table-column>
      <el-table-column align="center" label="供货商名称" width="250" prop="supplierName" ></el-table-column>
     <!-- <el-table-column align="center" label="企业名称" width="150" prop="enterpiseName" ></el-table-column>  -->
      <el-table-column align="center" label="生产商名称" width="250" prop="productionName" ></el-table-column>

      <el-table-column align="center" label="产地" width="150" prop="originPlace" ></el-table-column>
       <el-table-column width="110px" align="center" label="状态" prop="materialStatus" :formatter="statusFormatter"></el-table-column>
      ...
      <el-table-column  align="center" fixed="right" label="操作" width="150"  v-if="needFixedRight" >
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="primary"  @click="handleUpdate(scope.row)" v-if="scope.row.validStatus!=3">编辑</el-button>
        </template>
      </el-table-column>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="供货商" prop="supplierId" >
                  <el-select  v-model="form.supplierId" placeholder="请选择"  clearable  :filterable="true" :disabled="viewReadOnly">
...
<script>
  ...
  export default {
      ...
      created() {
        this.getList();
         getSuppliers(this.user.enterpriseId).then(response => {
