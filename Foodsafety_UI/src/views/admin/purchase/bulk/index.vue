<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="tableList" v-loading.body="listLoading" border highlight-current-row style="width: 100%" @selection-change="getSelection" :row-class-name="tableRowClassName" :height="height" tooltip-effect="dark">
      ...
      <!-- <el-table-column width="150px" align="center" label="采购编号" prop="purchaseId"></el-table-column>
             <el-table-column width="150px" align="center" label="所属企业" prop="enterpriseId"></el-table-column>
             <el-table-column width="150px" align="center" label="原料编号" prop="materialId"></el-table-column> -->
      <!-- <el-table-column width="150px" align="center" label="原料类型" prop="materialCategory"></el-table-column> -->
      <!-- <el-table-column width="150px" align="center" label="供货商编号" prop="supplierId"></el-table-column> -->
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item label="保质期" prop="shelfLife" ref="shelfLife" tab="0">
                    <el-input-number v-model.trim="form.shelfLife" :min="1" label="" :disabled="userManager_view" disabled></el-input-number>天
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  ...
                  <el-row>
                    <el-col>
                      <el-form-item label="质检照片" prop="inspectionReportPhoto" ref="inspectionReport" v-if="!reportDisable" :rules="{required: true, message: '质检报告照片不能为空'}" :disabled="userManager_view">
                        <!-- <el-form-item label="质检照片" prop="inspectionReportPhoto" ref="inspectionReport" v-if="!reportDisable" :disabled="userManager_view"> -->
  ...
  data() {
    ...
    return {
      ...
      form: {
        ...
        materialCategory: "2", //原材料的类型(预包装食品、散装食品、食品相关产品、食品添加剂、农产品和其他产品)
      ...
      rules: {
        ...
        purchaseDate: [
          { required: true, message: "进货日期不能为空" },
  ...
  methods: {
    intiParam() {
      ...
      if (_this.user.userType == 4) {
        ...
        //原料信息
        getMaterialsMap(_this.user.enterpriseId, _this.form.materialCategory)
