<template>
  <div>
    ...
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading"
      ...
      <el-table-column width="300px" align="center" label="生产地址" prop="productionAddress">
...
<script>
  ...
  import {getEnterpriseInspectionPlanTask} from 'api/admin/dashboard/index';
  export default {
    name: "inspectionPlan",
    props: ["gridId"],
    components: {
    ...
    methods: {
      ...
      getList() {
        ...
        getEnterpriseInspectionPlanTask(this.listQuery).then(response => {
