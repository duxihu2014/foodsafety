<template>
  <div >
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border highlight-current-row style="width: 100%"  height="60vh">
      ...
      <el-table-column width="250px" align="center" label="企业名称" prop="enterpriseName" v-if="this.user.userType!=4">
      </el-table-column>
      ...
      <el-table-column width="180px" align="center" label="上次检查问题" prop="mainProblems">
      </el-table-column>
...
<script>
  ...
  import { getPersonnelMap, getInstitutionMap } from "api/admin/safety/revisit/index";
  ...
  import {getRevisitPlanTask} from 'api/admin/dashboard/index';
