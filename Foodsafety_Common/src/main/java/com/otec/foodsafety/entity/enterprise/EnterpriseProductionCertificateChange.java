...
@Table(dataBase = DataBase.MYSQL, tabName = "T_ENTERPRISE_PRODUCTION_CERTIFICATE_CHANGE", pkId = "changeId", seqName = "",notColumn = {""})
public class EnterpriseProductionCertificateChange implements Serializable {
