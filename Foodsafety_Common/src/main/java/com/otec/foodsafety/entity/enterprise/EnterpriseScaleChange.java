...
@Table(dataBase = DataBase.MYSQL, tabName = "T_ENTERPRISE_SCALE_CHANGE", pkId = "changeId", seqName = "",notColumn = {""})
public class EnterpriseScaleChange implements Serializable {
