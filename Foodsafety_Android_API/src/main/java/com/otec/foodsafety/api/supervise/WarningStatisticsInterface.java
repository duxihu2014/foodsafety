...
public class WarningStatisticsInterface extends BaseInterface {
    ...
    @ResponseBody
    public Map<String, Integer> warningStatistics(@RequestParam Map<String, String> params,@PathVariable String enterpriseId) {
...
//			STATUS   ，
            ...
            Integer already_deal = alarmService.countAlarmByCondition(mapAlerm);
            datamap.put(warning_items_show[i], un_deal+already_deal);
        }
        return datamap;
    }
    ...
    @ResponseBody
    public GridDataModel behaviorWarningDetail(@PathVariable String enterpriseId
    ) {
    ...
    @ResponseBody
    public GridDataModel temperatureWarningDetail(@PathVariable String enterpriseId
    ) {
